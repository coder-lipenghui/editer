package view.window 
{
	 ...
	 */
	public class BaseData extends WindowProjectUI 
	{
		...
		public function BaseData() 
		{
			...
			_group = [
				[DataManager.itemDef.data, DataManager.monDef.data,DataManager.monDrop.data,null,DataManager.levelInfo.data], //基础表
