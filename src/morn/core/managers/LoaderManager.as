...
package morn.core.managers {
	...
	public class LoaderManager extends EventDispatcher {
		...
		/**加载macos本地位图，返回Bitmapdata*/
		public function loadMacOsLocalBMD(url:String, complete:Handler = null, progress:Handler = null, error:Handler = null, isCacheContent:Boolean = true):void {
			url="file:///"+url;
