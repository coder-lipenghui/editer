...
package morn.core.managers {
	...
	public class ResLoader {
		...
		public static var minBytePre5Second:int = 4096;
		...
		private var _jpgLoaderContext:JPEGLoaderContext=new JPEGLoaderContext();
//		private var _loaderContext:LoaderContext = new LoaderContext(false, ApplicationDomain.currentDomain,SecurityDomain.currentDomain);
		...
		private function onStatus(e:HTTPStatusEvent):void {
			//trace("查看加载状态：",e.status);
		}
		private function onSecurityError(e:SecurityErrorEvent):void
		{
			App.log.error("Security Error:",e.toString());
			endLoad(null);
		}
